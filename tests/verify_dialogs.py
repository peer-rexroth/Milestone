...
with sync_playwright() as p:
    ...
    check("...sections: Working week, Scheduling precision, Public holidays, Another day off, Days off in this plan", [t.strip().split("\n")[0].strip().upper() for t in pg.locator("#calendarModalBg .cal-sec-title").all_inner_texts()] == ["WORKING WEEK OF “MY PROJECT”", "SCHEDULING PRECISION", "PUBLIC HOLIDAYS", "ANOTHER DAY OFF A SINGLE DAY, A BREAK, OR A DAY THAT COMES BACK EVERY YEAR", "DAYS OFF IN THIS PLAN"] or len(pg.locator("#calendarModalBg .cal-sec-title").all()) == 5)
