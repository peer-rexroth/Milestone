...
| `verify_minute_ui` | minute-mode scheduling precision, the UI: the precision toggle and working-hours/breaks editor, the task dialog's time inputs and hour/minute duration entry, the grid's date+time display and adapted column widths, day mode reverting all of it |
